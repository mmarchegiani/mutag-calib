...
# All Run 2 years share the same pt_binning, msd_binning, and WPs,
# so we use "2018" as reference for the config dicts.
pt_binning = parameters["mutag_calibration"]["pt_binning"]["2018"]
wp_dict = parameters["mutag_calibration"]["wp"]["2018"]
msd_binning = parameters["mutag_calibration"]["msd_binning"]["2018"]
