...
cfg = Configurator(
    ...
    categories = {
        ...
        "pt250msd50mreg50to200_BTagMu_AK8DiJet170_Mu5": [get_ptmsd(250., 50.), get_mregbin(50., 200.), get_HLTsel_custom(["BTagMu_AK8DiJet170_Mu5"])],
        "pt250msd50mreg50to200_BTagMu_AK8Jet170_DoubleMu5": [get_ptmsd(250., 50.), get_mregbin(50., 200.), get_HLTsel_custom(["BTagMu_AK8Jet170_DoubleMu5"])],
        "pt250msd50mreg50to200_BTagMu_AK8Jet300_Mu5": [get_ptmsd(250., 50.), get_mregbin(50., 200.), get_HLTsel_custom(["BTagMu_AK8Jet300_Mu5"])],
        "pt250msd50mreg50to200_BTagMu_AK4Jet300_Mu5": [get_ptmsd(250., 50.), get_mregbin(50., 200.), get_HLTsel_custom(["BTagMu_AK4Jet300_Mu5"])],
    },
